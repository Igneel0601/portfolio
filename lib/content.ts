  ...
  cats: [
    {
      ...
      rows: [
        { name: "Neovim", note: "My whole personality, configured in Lua.", meta: "daily" },
        { name: "WezTerm", note: "GPU terminal. Yes, I can tell the difference.", meta: "daily" },
        { name: "tmux", note: "So I can pretend the crash didn't happen.", meta: "" },
        { name: "Starship", note: "A prompt that warns me which branch I'm about to regret.", meta: "" },
      ],
    },
    {
      key: "machine",
      label: "machine",
      rows: [
        { name: "Framework 13", note: "AMD. Repairable — the repairable part is the whole point.", meta: "primary" },
        ...
        { name: "32 GB RAM", note: "For the 200 Chrome tabs I refuse to close.", meta: "" },
      ],
    },
    {
      key: "desk",
      ...
      rows: [
        { name: "Keychron Q1", note: "Gateron Browns, hot-swapped twice out of pure boredom.", meta: "daily" },
        { name: "MX Master 3S", note: "The only mouse I haven't taken apart yet.", meta: "" },
        { name: '27" 1440p', note: "One screen. Two virtual desktops too many.", meta: "" },
        { name: "WH-1000XM4", note: "Noise-cancelling, mostly bought for the silence.", meta: "daily" },
      ],
    },
    {
      key: "software",
      label: "software",
      rows: [
        { name: "Obsidian", note: "Second brain. Also the first place I lose things.", meta: "daily" },
        ...
        { name: "Rofi", note: "Launcher. Pure muscle memory at this point.", meta: "" },
      ],
    },
    {
      key: "web",
